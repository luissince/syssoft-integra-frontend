                ...
                <div className="form-group">
                    {
                        idAlmacen && (
                            <>
                                ...
                                <p className='m-0'>{cantidad} cantidad - {cantidadMinima} min - {cantidadMaxima} max</p>
                            </>
                        )
                    }
                    {
                        !idAlmacen && (
                            <>
                                <p className='m-0'>Almacen <i className="fa fa-asterisk text-danger small"></i> </p>
                                <p className='m-0'> Agregar aquí la cantidad inicial de tu producto</p>
                            </>
                        )
                    }
                </div>
