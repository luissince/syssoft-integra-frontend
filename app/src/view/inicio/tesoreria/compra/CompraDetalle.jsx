                        ...
                        <div className="form-group">
                            <div className="table-responsive">
                                <table width="100%">
                                    <thead>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Fecha Compra</th>
                                        ...
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Proveedor</th>
                                        ...
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Telefono</th>
                                        ...
                                        <tr>
                                            ...
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{/*{this.state.notas}*/}Almacen 01</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                        ...
                        <div className="form-group">
                            <div className="table-responsive">
                                <table width="100%">
                                    <thead>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Serie - Nuymeración</th>
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{/*{this.state.comprobante}*/}F001-000123</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Comprobante</th>
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{/*{this.state.comprobante}*/}Factura</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Tipo y Estado</th>
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{/*{this.state.cliente}*/}01 - Pagada</th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{/*{this.state.notas}*/} N/D</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Total</th>
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{/*{this.state.notas}*/}S/. 2000.00</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                        ...
                        <div className="form-group">
                            <div className="table-responsive">
                                <table width="100%">
                                    <thead>
                                        <tr>
                                            <th className="table-secondary w-35 p-1 font-weight-normal ">EGRESO TOTAL</th>
                                            <th className="table-light border-bottom border-right w-65 pl-2 pr-2 pt-1 pb-1 font-weight-bold">{/*{this.state.notas}*/}S/. 0.00</th>
                                        </tr>
                                    </thead>
                                </table>
