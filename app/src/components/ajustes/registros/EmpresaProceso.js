        ...
        ModalAlertDialog("Empresa", "¿Está seguro de continuar?", async () => {
            try {
                ...
                if (error.response) {
                    ...
                    ModalAlertWarning("Empresa", "Se produjo un error un interno, intente nuevamente.");
                }
            }
        });
                ...
                <div className='row'>
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <section className="content-header">
                            <h5>
                                <span role="button" onClick={() => this.props.history.goBack()}><i className="bi bi-arrow-left-short"></i></span> Editar Empresa
                            </h5>
                        </section>
                    </div>
                </div>
