...
class Clientes extends React.Component {
    ...
    onEventNuevoCliente = () => {
        ...
        // this.props.history.push(`${this.props.location.pathname}/cliente`)
    }
                                            ...
                                            this.state.lista.map((item, index) => {
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <button className="btn btn-outline-dark btn-sm" title="Editar" onClick={() => this.props.history.push({ pathname: `${this.props.location.pathname}/cliente`, search: "?idCliente=" + item.idCliente })}><i className="bi bi-pencil"></i></button>
                                                        </td>
                                                    </tr>
                                                )
                                            })
