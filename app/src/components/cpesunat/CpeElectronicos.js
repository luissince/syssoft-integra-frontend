        ...
        ModalAlertDialog("Facturación", "¿Está seguro de enviar el comprobante electrónico?", async (value) => {
            if (value) {
                try {
                    ...
                    let result = await axios.get("https://sunat.inmobiliariagmyc.com/app/examples/boleta.php", {
                        params: {
                            "idventa": idVenta
                        }
                    });
        ...
        ModalAlertDialog("Facturación", "¿Está seguro de anular el comprobante electrónico?", async (value) => {
            if (value) {
                try {
                    ...
                    let result = await axios.get("https://sunat.inmobiliariagmyc.com/app/examples/resumen.php", {
                        params: {
                            "idventa": idVenta
                        }
                    });
