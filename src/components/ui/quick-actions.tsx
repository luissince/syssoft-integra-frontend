...
import { ShoppingCart, ShoppingBag, FileText, Truck, Package } from "lucide-react"
          ...
          {actions.map((action) => {
            ...
            return (
              <Link key={action.label} to={action.href}>
                <Button variant="outline" className="w-full h-auto flex flex-col items-center justify-center p-4 gap-2">
