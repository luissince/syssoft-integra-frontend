                    ...
                    <div className="container-fluid py-1 px-3">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                <li className="breadcrumb-item text-sm"><a className="text-muted text-decoration-none" role="button">Pages</a></li>
                                <li className="breadcrumb-item text-sm text-dark">Dashboard</li>
                            </ol>
                            <h6 className="font-weight-bolder mb-0">Dashboard</h6>
                        </nav>
                        <form className="form-inline">
                            <input className="form-control mr-sm-2 bg-transparent" type="search" placeholder="Search" aria-label="Search" />
                ...
                <div className="container-fluid py-4 ">
                    <div className="row ">
                        <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                            <div className="card" style={{ borderRadius: 10, boxShadow: '0 7px 10px -5px rgba(64,64,64,.4)' }}>
                                <div className="card-header p-3 pt-2 bg-transparent">
                                    <div className="bg-dark position-absolute" style={{ color: 'white', marginTop: -35, height: '38%', width: '18%', borderRadius: 10, display: 'flex', fontSize: 20, boxShadow: '0 7px 10px -5px rgba(64,64,64,.4)' }}>
                                        <i className="bi bi-calendar-week-fill" style={{ margin: 'auto' }}></i>
                                    </div>
                        ...
                        <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                            <div className="card" style={{ borderRadius: 10, boxShadow: '0 7px 10px -5px rgba(64,64,64,.4)' }}>
                                <div className="card-header p-3 pt-2 bg-transparent">
                                    <div className="position-absolute" style={{ color: 'white', marginTop: -35, height: '38%', width: '18%', borderRadius: 10, display: 'flex', background: '#ec407a', fontSize: 20, boxShadow: '0 7px 10px -5px rgba(233,30,99,.4)' }}>
                        ...
                        <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                            <div className="card" style={{ borderRadius: 10, boxShadow: '0 7px 10px -5px rgba(64,64,64,.4)' }}>
                                <div className="card-header p-3 pt-2 bg-transparent">
                                    <div className="position-absolute" style={{ color: 'white', marginTop: -35, height: '38%', width: '18%', borderRadius: 10, display: 'flex', background: '#66bb6a', fontSize: 20, boxShadow: '0 7px 10px -5px rgba(76,175,80,.4)' }}>
                                        <i className="bi bi-person-fill" style={{ margin: 'auto' }}></i>
                                    </div>
                                    <div className="text-right pt-1">
                        ...
                        <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                            <div className="card" style={{ borderRadius: 10, boxShadow: '0 7px 10px -5px rgba(64,64,64,.4)' }}>
                                <div className="card-header p-3 pt-2 bg-transparent">
                                    <div className="position-absolute" style={{ color: 'white', marginTop: -35, height: '38%', width: '18%', borderRadius: 10, display: 'flex', background: '#49a3f1', fontSize: 20, boxShadow: '0 7px 10px -5px rgba(0,188,212,.4)' }}>
                                        <i className="bi bi-clipboard-data-fill" style={{ margin: 'auto' }}></i>
                                    </div>
                                    <div className="text-right pt-1">
                    ...
                    <div className="row mb-4">
                        ...
                        <div class="card h-100">
                            <div class="card-header pb-0">
                                ...
                                <p class="text-sm">
                                    <i class="bi bi-arrow-up" aria-hidden="true" style={{color:'green'}}></i>
                                ...
                                <div class="timeline ">
                                    <div class="timeline-block mb-3">
                                        <span class="timeline-step">
                                            <i class="bi bi-bell-fill text-success text-gradient"></i>
                                        </span>
                                    ...
                                    <div class="timeline-block mb-3">
                                        <span class="timeline-step">
                                            <i class="bi bi-code text-danger text-gradient"></i>
                                        </span>
                                        <div class="timeline-content">
