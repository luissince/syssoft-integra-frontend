...
const Menu = ({ refSideBar, path, url, pathname, token: { project, userToken } }) => {
                                                                ...
                                                                collapsibleItems.forEach(element => {
                                                                    ...
                                                                    anchorList.forEach(a => {
                                                                        if (rutaBase === a.getAttribute("href")) {
                                                                            const parentListItem = a.parentNode.parentNode.parentNode;
                                                                            const parentAnchor = parentListItem.querySelector("a");
