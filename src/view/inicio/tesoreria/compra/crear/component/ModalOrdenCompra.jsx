...
import CustomModal, { CustomModalContentBody, CustomModalContentFooter, CustomModalContentHeader, CustomModalContentOverflow, CustomModalContentScroll } from '../../../../../../components/CustomModal';
import { SpinnerTable } from '../../../../../../components/Spinner';
import { currentDate, formatNumberWithZeros, formatTime, isEmpty, keyUpSearch, numberFormat } from '../../../../../../helper/utils.helper';
    ...
    render() {
        ...
        return (
            <CustomModal
                ...
                onClose={handleClose}
                contentLabel="Modal de Orden de Compra"
                            ...
                            <div className='p-3'>
                                <Row>
                                    <Column className={"col-md-6 col-12"} formGroup={true}>
                                        <Input
                                            group={true}
                                            label={<><i className="fa fa-search"></i> Buscar por N° de Orden de Compra o Proveedor:</>}
                                            placeholder="Buscar..."
                                            value={buscar}
