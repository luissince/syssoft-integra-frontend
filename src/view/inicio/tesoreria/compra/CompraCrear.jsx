...
import { comboAlmacen, comboComprobante, comboImpuesto, comboMetodoPago, comboMoneda, createCompra, filtrarCliente, filtrarProducto } from '../../../../network/rest/principal.network';
...
class CompraCrear extends CustomComponent {
  ...
  */
    ...
    */
    ...
    async componentDidMount() {
        ...
        viewModal(this.idModalProduct, () => {
            ...
            this.setState({ costoModalProducto: this.state.producto.costo, loadingModalProducto: false })
        });
    ...
    */
    ...
    loadData = async () => {
        const [comprobantes, monedas, metodoPagos, almacenes, impuestos] = await Promise.all([
    ...
    */
    ...
    handleProcessCredito = async () => {
        ...
        if (tipoCredito === '2' && isNumeric(numeroCuotas)) {
            alertWarning("Compra", "Tiene que agregar método de gasto para continuar.", () => {
    ...
    handleClearInputProducto = async () => {
        await this.setStateAsync({ productos: [], filtrarProducto: "", producto: null });
        this.selectItemProducto = false;
    }
    ...
    handleFilterProducto = async (event) => {
        ...
        await this.setStateAsync({ productos: filteredProductos, loadingProducto: false });
    }
    ...
    handleGuardar = async () => {
        ...
        if (!isText(idComprobante)) {
            alertWarning("Compra", "Seleccione su comprobante.", () => this.refComprobante.current.focus())
            return;
        }

        if (isEmpty(cliente)) {
            alertWarning("Compra", "Seleccione un cliente.", () => this.refCliente.current.focus())
            return;
        }

        if (!isText(idMoneda)) {
            alertWarning("Compra", "Seleccione su moneda.", () => this.refMoneda.current.focus())
            return;
        }

        if (!isText(idAlmacen)) {
            alertWarning("Compra", "Seleccione su almacen.", () => this.refAlmacen.current.focus())
            return;
        }

        if (isEmpty(detalle)) {
            alertWarning("Compra", "Agregar algún producto a la lista.", () => this.refProducto.current.focus())
            return;
        }
                ...
                <div className='row'>
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className="form-group">
                            <h5>
                                <span role="button" onClick={() => this.props.history.goBack()}><i className="bi bi-arrow-left-short"></i></span> Compra
                ...
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        ...
                        <div className="form-group">
                            <div className="input-group">
                                <div className="input-group-prepend">
                                    <div className="input-group-text"><i className="bi bi-percent"></i></div>
                                </div>
                                <select
                                    className="form-control"
                                ...
                                <select
                                    ...
                                    <option value={""}>-- Almacen --</option>
                                    {
                                        this.state.almacenes.map((item, index) => {
                                            return <option key={index} value={item.idAlmacen}>{item.nombre}</option>
                                        })
                                    }
                                </select>
                            </div>
                        ...
                        <div className="form-group">
                            <div className="input-group">
                                <div className="input-group-prepend">
                                    <div className="input-group-text"><i className="bi bi-card-text"></i></div>
                                </div>
                                <textarea
                                    title="Observaciones..."
                                    className="form-control"
                    ...
                    <div className="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div className="row">
                            ...
                            <div className="col-md-8">
                                <div className="form-check form-check-inline mt-2">
                                    ...
                                    <label className="form-check-label" htmlFor="inlineRadio1"> Actualizar costo Inventario</label>
                                </div>
                            </div>
                        </div>
                        <div className="row mt-4">
                            <div className="col-lg-6">
                                <div className="form-group">
                                    <label htmlFor="notas">Visibles en el documento impreso</label>
                                    <textarea className="form-control" id="notas" rows="2"></textarea>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="form-group">
                                    <label htmlFor="observaciones">No visibles en el documento impreso</label>
                                ...
                                <table width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="table-light border-top border-bottom border-right w-65 pl-2 pr-2 pt-1 pb-1 font-weight-normal">S/. 0.00</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-35 p-1 font-weight-normal ">Descuento</th>
                                            <th className="table-light border-bottom border-right w-65 pl-2 pr-2 pt-1 pb-1 font-weight-normal">S/. 0.00</th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th className="table-light border-bottom border-right w-65 pl-2 pr-2 pt-1 pb-1 font-weight-bold">S/. 0.00</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
