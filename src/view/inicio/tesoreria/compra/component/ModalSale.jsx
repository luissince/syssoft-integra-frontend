...
const ModalSale = (props) => {
    ...
    return (
        <div className="modal fade" id={idModal} data-bs-keyboard="false" data-bs-backdrop="static">
                        ...
                        <div className="row">
                            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div className="text-center">
                                    <h5>TOTAL A COBRAR: <span>{numberFormat(importeTotal, codISO)}</span></h5>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className='form-group'>
                                                ...
                                                <div className="form-check form-check-inline">
                                                    ...
                                                    <label className="form-check-label" htmlFor="2">
                                                        <i className="bi bi-bag-check-fill "></i>  Variable</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        tipoCredito === '1' && (
                                            <>
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="form-group">
                                                            <span className="text-md"><i className="bi bi-info-circle text-success text-lg"></i> Los pagos se realizan de acuerdo con la frecuencia establecida, con alertas programadas para recordar las fechas de pago.</span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        tipoCredito === '2' && (
                                            <>
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="form-group">
                                                            <span className="text-md"><i className="bi bi-info-circle text-success text-lg"></i> Los pagos se efectúan en función del número de cuotas, con una alerta que indica la frecuencia de los pagos.</span>
                                                        </div>
                                                    </div>
                                                </div>
...
const MetodoPago = ({ idMetodoPago, nameMetodPay, monto, handleInputMontoMetodoPay, handleRemoveItemMetodPay, handleSaveSale }) => {
    return (
