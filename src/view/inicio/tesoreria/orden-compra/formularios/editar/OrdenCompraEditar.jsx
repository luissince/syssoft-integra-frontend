...
class OrdenCompraEditar extends CustomComponent {
  ...
  */
  ...
  handleDocumentKeyDown = (event) => {
    if (event.key === 'F1' && !this.state.isOpenProducto && !this.state.isOpenPersona && !this.state.isOpenImpresion) {
      this.handleGuardar();
    }
  }
  ...
  //------------------------------------------------------------------------------------------
  handleGuardar = async () => {
    const { idOrdenCompra, idComprobante, proveedor, idMoneda, idImpuesto, observacion, nota, detalles } = this.state;
            ...
            <div className='w-100 d-flex flex-column position-relative'
              ...
              <div className='d-flex align-items-center px-3'
                ...
                <div className='py-3 d-flex align-items-center'>
                  <p className='h5 m-0'>Editar Orden de Compra <i className='fa fa-plus text-secondary'></i> </p>
                </div>
              </div>
...
const ConnectedOrdenCompraEditar = connect(mapStateToProps, null)(OrdenCompraEditar);
