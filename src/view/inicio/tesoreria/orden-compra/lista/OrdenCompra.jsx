...
class OrdenCompras extends CustomComponent {
  ...
  loadingData = async () => {
    if (this.props.ordenCompraLista && this.props.ordenCompraLista.data && this.props.ordenCompraLista.paginacion) {
      this.setState(this.props.ordenCompraLista.data)
      this.refPaginacion.current.upperPageBound = this.props.ordenCompraLista.paginacion.upperPageBound;
      this.refPaginacion.current.lowerPageBound = this.props.ordenCompraLista.paginacion.lowerPageBound;
      this.refPaginacion.current.isPrevBtnActive = this.props.ordenCompraLista.paginacion.isPrevBtnActive;
      this.refPaginacion.current.isNextBtnActive = this.props.ordenCompraLista.paginacion.isNextBtnActive;
      this.refPaginacion.current.pageBound = this.props.ordenCompraLista.paginacion.pageBound;
      this.refPaginacion.current.messagePaginacion = this.props.ordenCompraLista.paginacion.messagePaginacion;
    } else {
  ...
  fillTable = async (opcion, buscar = '') => {
    ...
    const response = await listOrdenCompra(params, this.abortControllerTable.signal);
...
const mapDispatchToProps = { setListaOrdenCompraData, setListaOrdenCompraPaginacion }

const ConnectedOrdenCompras = connect(mapStateToProps, mapDispatchToProps)(OrdenCompras);
