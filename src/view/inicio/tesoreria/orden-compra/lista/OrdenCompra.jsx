  ...
  */
  ...
  renderTable() {
    ...
    return this.state.lista.map((item) => {
      return (
        <tr key={item.idOrdenCompra} className="hover:bg-gray-50 transition-colors">
          ...
          <td className="px-2 py-4 text-center">
            <span
              className={cn(
                "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium",
                item.estado === 1 ? "bg-gray-500 text-white" : "bg-green-500 text-white",
              )}
            >
              {item.ligado}
            </span>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider w-[10%]">Ligado</th>
