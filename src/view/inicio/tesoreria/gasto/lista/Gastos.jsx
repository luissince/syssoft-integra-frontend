...
import { cancelGasto, listGasto } from '../../../../../network/rest/principal.network';
...
class Gastos extends CustomComponent {
    ...
    fillTable = async (opcion, buscar) => {
        ...
        const response = await listGasto(params, this.abortControllerTable.signal);
    ...
    handleDetalle = (idGasto) => {
        this.props.history.push({
            pathname: `${this.props.location.pathname}/detalle`,
            search: "?idGasto=" + idGasto
        })
    }

    handleAnular = (idGasto) => {
        alertDialog("Gasto", "¿Está seguro de que desea eliminar el gasto? Esta operación no se puede deshacer.", async (value) => {
            if (value) {
                ...
                <div className='row'>
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className="form-group">
                            <h5>Gastos y Salidas <small className="text-secondary">LISTA</small></h5>
                        </div>
                    </div>
                </div>
