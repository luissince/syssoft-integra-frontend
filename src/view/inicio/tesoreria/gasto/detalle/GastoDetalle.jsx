...
class GastoDetalle extends CustomComponent{
    ...
    async loadDataId(id) {
        const [gasto] = await Promise.all([
            await this.fetchDetailGasto(id)
        ])
                        ...
                        <div className="form-group">
                            <div className="table-responsive">
                                <table width="100%">
                                    <thead>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal "><span>Comprobante:</span></th>
                                        ...
                                        <tr>
                                            ...
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">
                                                {
                                                    this.state.estado === 1
                                                        ? <span className="text-success font-weight-bold">Cobrado</span>
                                    ...
                                    <tbody>
                                        {
                                            this.state.salidas.length === 0 ?
                                                <tr>
                                                    <td colSpan="5" className="text-center">No hay salidas para mostrar.</td>
                                                </tr>
                                                :
