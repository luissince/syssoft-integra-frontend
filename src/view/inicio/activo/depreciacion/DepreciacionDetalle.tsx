        ...
        <ContainerWrapper>
            ...
            <div className="w-full">
                <div className="flex items-center justify-between gap-3 mb-3">
                    ...
                    <button
                        className={`inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded 
                            hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition
                            ${isEmpty(depreciaciones)
                                ? "cursor-pointer"
                                : "cursor-not-allowed opacity-50"}`}
                        disabled={!isEmpty(depreciaciones)}
                        onClick={isEmpty(depreciaciones) ? handleCrearDepreciacion : undefined}
                    >
