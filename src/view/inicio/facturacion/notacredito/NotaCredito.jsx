...
class NotaCredito extends CustomComponent {
  ...
  onEventAnularNotaCredito(idNotaCredito) {
    alertDialog(
      'Nota de Crédito',
      '¿Está seguro de que desea eliminar la nota de crédito? Esta operación no se puede deshacer.',
      async (value) => {
        if (value) {
          try {
        ...
        <div className="row">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="form-group">
              <h5>
                Nota de Crédito <small className="text-secondary">LISTA</small>
              </h5>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-6 col-sm-12">
            <div className="form-group">
              <button
                ...
                onClick={this.onEventNuevaVenta}
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            ...
                            {<br />}
                            {item.serieModi + '-' + item.numeracionModi}
                          </td>
