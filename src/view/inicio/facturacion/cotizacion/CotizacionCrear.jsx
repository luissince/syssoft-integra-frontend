                ...
                <div className='row'>
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className="form-group">
                            <h5><span role="button" onClick={() => this.props.history.goBack()}><i className="bi bi-arrow-left-short"></i></span> Cotización
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-group mb-2">
                                ...
                                <input
                                    ...
                                    onKeyUp={(event) => keyUpSearch(event, () => this.searchCliente(event.target.value))}
                                />
                            </div>
                        </div>
                    </div>
 ...
 */
export default connect(mapStateToProps, null)(CotizacionCrear);