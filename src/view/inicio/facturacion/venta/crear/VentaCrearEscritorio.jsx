      ...
      <PosContainerWrapper>
        ...
        <section className="invoice-left">
          ...
          <div className="h-100 d-flex flex-column items">
            ...
            <div className="d-flex align-items-center justify-content-between px-4 pt-4 pb-1">
              ...
              <div className="w-100 mr-2">
                <div className="input-group">
                  ...
                  <input
                    ...
                    placeholder={`Ingrese el codigo de barras o clave alterna.`}
                    // ref={refProducto}
                    // value={producto}
              ...
              <button className='btn btn-outline-success d-flex align-items-center justify-content-center' style={{ minWidth: "10rem" }}>
                <i className="fa fa-cubes mr-2"></i> Producto
              </button>
            ...
            {/* <div className="d-flex align-items-center justify-content-between mx-4 rounded bg-white">
              <div className="pt-2">
