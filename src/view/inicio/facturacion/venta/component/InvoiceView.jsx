...
const InvoiceView = (props) => {
    ...
    const { refProducto, producto, productos, sarchProducto, idSucursal, filterProducto, handleFilterProducto, handleAddItem } = props;
...
const ListSearchItems = ({ productos, sarchProducto, handleAddItem, handleStarProduct }) => {
    if (sarchProducto) {
        return (
