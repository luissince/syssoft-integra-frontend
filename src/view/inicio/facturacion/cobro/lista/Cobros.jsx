...
import { cancelCobro, listCobro } from '../../../../../network/rest/principal.network';
...
class Cobros extends CustomComponent {
    ...
    handleAnular = (idCobro) => {
        alertDialog("Cobro", "¿Está seguro de que desea eliminar el cobro? Esta operación no se puede deshacer.", async (value) => {
            if (value) {
