    ...
    return this.state.lista.map((item) => {
      return (
        <tr key={item.idPedido} className="hover:bg-gray-50 transition-colors">
          ...
          <td className="px-6 py-4 text-sm text-gray-900">
            <div className={this.getStatusColor(item.estado)}>
              ...
              >
                <div className="flex flex-col gap-2 p-4">
                  <div className="flex justify-between items-start">
                    ...
                    <span className={this.getStatusColor(item.estado)}>
                      {this.getStatusText(item.estado)}
                    </span>
                  </div>
                  ...
                  <div className="text-sm text-gray-600">
                    <span className="font-medium">Tipo Entegra:</span> {item.tipoEntrega}
                  </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider w-[10%] text-left">Tipo Entrega</th>
