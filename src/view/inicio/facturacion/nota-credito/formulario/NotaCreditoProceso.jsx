...
class NotaCreditoProceso extends CustomComponent {
  ...
  async searchComprobante() {
    if (this.state.buscar === '') {
      await this.setStateAsync({
        messageWarning: 'Ingrese el comprobante a consultar.',
      });
        ...
        <div className="row">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="form-group">
              <h5>
                Nota de Crédito{' '}
                <small className="text-secondary">REGISTRAR</small>
              </h5>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="form-group">
              <button
                ...
                onClick={() => this.onEventSaveNotaCredito()}
              >
            ...
            <div className="form-group">
              <select
                ...
                onChange={async (event) => {
                  if (event.target.value !== '') {
                    await this.setStateAsync({
                      idMotivo: event.target.value,
                      messageWarning: '',
                    });
                  } else {
                    await this.setStateAsync({
                      idMotivo: event.target.value,
                      messageWarning: 'Seleccione el motivo.',
                    });
                  }
                }}
              >
