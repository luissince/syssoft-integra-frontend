...
class CreditoProceso extends React.Component {
  ...
  async componentDidMount() {
    ...
    clearModal('modalPlazo', async () => {
      const impuestoFilter = this.state.impuestos.filter(
        (item) => item.preferida === 1,
      );

      const medidaFilter = this.state.medidas.filter(
        (item) => item.preferida === 1,
      );
      ...
      await this.setStateAsync({
        ...
        idImpuestoPlazo:
          impuestoFilter.length > 0 ? impuestoFilter[0].idImpuesto : '',
        expandedOpcionesPlazo: true,
      });
    });
    ...
    clearModal('modalAdelanto', async () => {
      ...
      if (this.refCollpseContentAdelanto.current.classList.contains('show')) {
        ...
        this.refCollpseAdelanto.current.attributes['aria-expanded'].value =
          false;
      }
      ...
      await this.setStateAsync({
        ...
        idPlazo: '',
        idMedidaAdelanto:
          medidaFilter.length > 0 ? medidaFilter[0].idMedida : '',
        idImpuestoAdelanto:
          impuestoFilter.length > 0 ? impuestoFilter[0].idImpuesto : '',
        expandedOpcionesAdelanto: true,
      });
    ...
    clearModal('modalIndividual', async () => {
      ...
      if (this.refCollpseContentIndividual.current.classList.contains('show')) {
        ...
        this.refCollpseIndividual.current.attributes['aria-expanded'].value =
          false;
      }
  ...
  async onEventOpenModal() {
    if (this.state.venta.credito === 1) {
      if (this.state.idComprobanteCuota === '') {
        const comprobanteFilter = this.state.comprobantes.filter(
          (item) => item.preferida === 1,
        );
        await this.setStateAsync({
          idComprobanteCuota:
            comprobanteFilter.length === 1
              ? comprobanteFilter[0].idComprobante
              : '',
        });
      }
      ...
      let validate = this.state.plazos.reduce(
        (acumulador, item) => (item.selected ? acumulador + 1 : acumulador + 0),
        0,
      );

      if (validate <= 0) {
        await this.setStateAsync({
          messageWarning: 'Seleccione algún crédito a cobrar.',
        });
        return;
      }
  ...
  async onEventCobrarCuota() {
    ...
    if (this.state.idImpuestoCuota === '') {
      if (!this.refCollpseContentCuota.current.classList.contains('show')) {
        ...
        await this.setStateAsync({
          expandedOpcionesCuota: !(
            this.refCollpseCuota.current.attributes[
              'aria-expanded'
  ...
  async onEventCobrarPlazo() {
    ...
    if (this.state.idImpuestoPlazo === '') {
      if (!this.refCollpseContentPlazo.current.classList.contains('show')) {
        ...
        await this.setStateAsync({
          expandedOpcionesPlazo: !(
            this.refCollpsePlazo.current.attributes[
              'aria-expanded'
            ].value.toLowerCase() === 'true'
          ),
        });
    ...
    if (this.state.idImpuestoAdelanto === '') {
      if (!this.refCollpseContentAdelanto.current.classList.contains('show')) {
        ...
        this.refCollpseAdelanto.current.attributes['aria-expanded'].value =
          true;
        await this.setStateAsync({
          expandedOpcionesAdelanto: !(
            this.refCollpseAdelanto.current.attributes[
              'aria-expanded'
            ].value.toLowerCase() === 'true'
          ),
        });
  ...
  handleCheck = async (event) => {
    ...
    let suma = updatedList.reduce(
      (acumulador, item) =>
        item.selected && parseInt(item.estado) === 0
          ? acumulador + item.monto
          : acumulador + 0,
      0,
    );
  ...
  async onEventRegistrarCobro() {
    ...
    if (this.state.idImpuestoCobro === '') {
      if (!this.refCollpseContentCobro.current.classList.contains('show')) {
        ...
        await this.setStateAsync({
          expandedOpcionesCobro: !(
            this.refCollpseCobro.current.attributes[
              'aria-expanded'
            ].value.toLowerCase() === 'true'
          ),
        });
  ...
  async onEventRegistrarIndividual() {
    ...
    if (this.state.idImpuestoIndividual === '') {
      if (
        !this.refCollpseContentIndividual.current.classList.contains('show')
      ) {
        ...
        this.refCollpseIndividual.current.attributes['aria-expanded'].value =
          true;
        await this.setStateAsync({
          expandedOpcionesIndividual: !(
            this.refCollpseIndividual.current.attributes[
              'aria-expanded'
            ].value.toLowerCase() === 'true'
          ),
        });
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                  ...
                  <div className="form-group col-md-12">
                    <div className="input-group">
                      ...
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({
                            idComprobantePlazo: event.target.value,
                          })
                        }
                      >
                ...
                <div className="form-row">
                  <div className="form-group col-md-12">
                    ...
                    >
                      Opciones{' '}
                      {this.state.expandedOpcionesPlazo ? (
                ...
                <div
                  ref={this.refCollpseContentPlazo}
                  className="collapse"
                  id="collapseOpcionesPlazo"
                >
                  <div className="form-row">
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({ idImpuestoPlazo: event.target.value })
                        }
                      >
                    ...
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({ idMedidaPlazo: event.target.value })
                        }
                      >
              ...
              <div className="modal-footer">
                <button
                  ...
                  onClick={() => this.onEventCobrarPlazo()}
                >
                  Guardar
                </button>
                <button
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                  ...
                  <div className="form-group col-md-12">
                    <div className="input-group">
                      ...
                      <select
                        ...
                        onChange={(event) => {
                          this.setState({
                            idComprobanteCuota: event.target.value,
                          });
                        }}
                      >
                        <option value="">-- Comprobantes --</option>
                ...
                <div className="form-row">
                  <div className="form-group col-md-12">
                    ...
                    >
                      Opciones{' '}
                      {this.state.expandedOpcionesCuota ? (
                        <i className="fa fa-plus-square"></i>
                      ) : (
                        <i className="fa fa-minus-square"></i>
                      )}
                ...
                <div
                  ref={this.refCollpseContentCuota}
                  className="collapse"
                  id="collapseOpcionesCuota"
                >
                  <div className="form-row">
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({ idImpuestoCuota: event.target.value })
                        }
                      >
                        <option value="">-- Impuesto --</option>
                        {this.state.impuestos.map((item, index) => (
                    ...
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({ idMedidaCuota: event.target.value })
                        }
                      >
                        <option value="">-- Unidad --</option>
                        {this.state.medidas.map((item, index) => (
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="btn btn-primary"
                  onClick={() => this.onEventCobrarCuota()}
                >
                  Guardar
                </button>
                <button
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                  ...
                  <div className="form-group col-md-12">
                    <div className="input-group">
                      ...
                      <select
                        ...
                        onChange={(event) => {
                          this.setState({
                            idComprobanteAdelanto: event.target.value,
                          });
                        }}
                      >
                        <option value="">-- Comprobantes --</option>
                ...
                <div className="form-row">
                  <div className="form-group col-md-12">
                    ...
                    >
                      Opciones{' '}
                      {this.state.expandedOpcionesAdelanto ? (
                        <i className="fa fa-plus-square"></i>
                      ) : (
                        <i className="fa fa-minus-square"></i>
                      )}
                ...
                <div
                  ref={this.refCollpseContentAdelanto}
                  className="collapse"
                  id="collapseOpcionesAdelanto"
                >
                  <div className="form-row">
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({
                            idImpuestoAdelanto: event.target.value,
                          })
                        }
                      >
                        <option value="">-- Impuesto --</option>
                    ...
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({
                            idMedidaAdelanto: event.target.value,
                          })
                        }
                      >
                        <option value="">-- Unidad --</option>
                ...
                <div className="form-row">
                  <div className="form-group col-md-12">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        this.setState({
                          observacionAdelanto: event.target.value,
                        })
                      }
                    />
                  </div>
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="btn btn-primary"
                  onClick={() => this.onEventCobrarAdelanto()}
                >
                  Guardar
                </button>
                <button
            ...
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="btn btn-primary"
                  onClick={() => this.onEventCambiarLoto()}
                >
                  Guardar
                </button>
                <button
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                  ...
                  <div className="form-group col-md-12">
                    <div className="input-group">
                      ...
                      <select
                        ...
                        onChange={(event) => {
                          this.setState({
                            idConceptoCobro: event.target.value,
                          });
                        }}
                      >
                        <option value="">-- seleccione --</option>
                  ...
                  <div className="form-group col-md-12">
                    <div className="input-group">
                      ...
                      <select
                        ...
                        onChange={(event) => {
                          this.setState({
                            idComprobanteCobro: event.target.value,
                          });
                        }}
                      >
                        <option value="">-- Comprobantes --</option>
                ...
                <div className="form-row">
                  <div className="form-group col-md-12">
                    ...
                    >
                      Opciones{' '}
                      {this.state.expandedOpcionesCobro ? (
                        <i className="fa fa-plus-square"></i>
                      ) : (
                        <i className="fa fa-minus-square"></i>
                      )}
                ...
                <div
                  ref={this.refCollpseContentCobro}
                  className="collapse"
                  id="collapseOpcionesCobro"
                >
                  <div className="form-row">
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({ idImpuestoCobro: event.target.value })
                        }
                      >
                        <option value="">-- Impuesto --</option>
                        {this.state.impuestos.map((item, index) => (
                    ...
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({ idMedidaCobro: event.target.value })
                        }
                      >
                        <option value="">-- Unidad --</option>
                        {this.state.medidas.map((item, index) => (
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="btn btn-primary"
                  onClick={() => this.onEventRegistrarCobro()}
                >
                  Guardar
                </button>
                <button
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                  ...
                  <div className="form-group col-md-12">
                    <div className="input-group">
                      ...
                      <select
                        ...
                        onChange={(event) => {
                          this.setState({
                            idConceptoIndividual: event.target.value,
                          });
                        }}
                        disabled
                      >
                  ...
                  <div className="form-group col-md-12">
                    <div className="input-group">
                      ...
                      <select
                        ...
                        onChange={(event) => {
                          this.setState({
                            idComprobanteIndividual: event.target.value,
                          });
                        }}
                      >
                        <option value="">-- Comprobantes --</option>
                ...
                <div className="form-row">
                  <div className="form-group col-md-12">
                    ...
                    >
                      Opciones{' '}
                      {this.state.expandedOpcionesIndividual ? (
                        <i className="fa fa-plus-square"></i>
                      ) : (
                        <i className="fa fa-minus-square"></i>
                      )}
                ...
                <div
                  ref={this.refCollpseContentIndividual}
                  className="collapse"
                  id="collapseOpcionesIndividual"
                >
                  <div className="form-row">
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({
                            idImpuestoIndividual: event.target.value,
                          })
                        }
                      >
                        <option value="">-- Impuesto --</option>
                    ...
                    <div className="form-group col-md-6">
                      <select
                        ...
                        onChange={(event) =>
                          this.setState({
                            idMedidaIndividual: event.target.value,
                          })
                        }
                      >
                        <option value="">-- Unidad --</option>
                ...
                <div className="form-row">
                  <div className="form-group col-md-12">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        this.setState({
                          observacionIndividual: event.target.value,
                        })
                      }
                    />
                  </div>
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="btn btn-primary"
                  onClick={() => this.onEventRegistrarIndividual()}
                >
                  Guardar
                </button>
                <button
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="form-group">
              <button
                ...
                disabled={this.state.venta.credito === 1 ? false : true}
                onClick={() => this.onEventOpenModal()}
              >
                <i className="fa fa-save"></i> Cobrar
              </button>{' '}
              <button
                type="button"
        ...
        <div className="row">
          <div className="col">
            ...
            <div className="form-group">
              <div className="pt-1 pb-1">
                Cliente: <strong>{documento + ' ' + informacion}</strong>
              </div>
              <div className="pt-1 pb-1">
                Teléfono y celular: <strong>{telefono + ' ' + celular}</strong>
              </div>
              <div className="pt-1 pb-1">
              ...
              <div className="pt-1 pb-1">
                Comprobante:{' '}
                <strong>{nombre + ' ' + serie + '-' + numeracion}</strong>
              </div>
          ...
          <div className="col">
            ...
            <div className="form-group">
              <div className="pt-1 pb-1">
                ...
                <strong>
                  {this.state.inicial.length === 0
                    ? 'Sin Inicial'
                    : numberFormat(
                        this.state.inicial.reduce(
                          (previousValue, currentValue) =>
                            previousValue + currentValue.monto,
                          0,
                        ),
                        codiso,
                      )}
              ...
              <div className="pt-1 pb-1">
                Monto Total: <strong>{numberFormat(total, codiso)}</strong>
              </div>
              <div className="pt-1 pb-1">
                Monto Cobrado:{' '}
                <span className="text-success">
                  {numberFormat(cobrado, codiso)}
                </span>
              </div>
              <div className="pt-1 pb-1">
                Monto Restante:{' '}
                <span className="text-danger">
                  {numberFormat(total - cobrado, codiso)}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <p className="lead">
              ...
              <button
                ...
                onClick={() => this.onEventOpenModelInicial()}
              >
        ...
        <div className="row">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <p className="lead">
              ...
              <button
                className="btn btn-primary btn-sm"
                onClick={() => this.onEventOpenModelCobro()}
              >
                <i className="fa fa-plus"></i>
              </button>
            </p>
                        ...
                        <td className="text-center">
                          {item.idConcepto === '' ? (
                            ...
                            <button
                              className="btn btn-info btn-sm"
                              onClick={() =>
                                this.onEventOpenModelIndividual(item.idConcepto)
                              }
                            >
                              <i className="fa fa-plus-circle"></i>
                            </button>
                ...
                <tbody>
                  {this.state.plazos.length === 0 ? (
                    ...
                    this.state.plazos.map((item, index) => {
                      ...
                      return (
                        <React.Fragment key={makeid(index + 1)}>
                          <tr className="table-success">
                            ...
                            >
                              {item.estado === 0 ? 'Por Cobrar' : 'Cobrado'}
                            </td>
                            ...
                            <td className="text-center">
                              <button
                                ...
                                onClick={() =>
                                  this.onEventOpenModalCobro(item.idPlazo)
                                }
                            ...
                            <td className="text-center">
                              <button
                                ...
                                className="btn btn-light btn-sm"
                                onClick={() =>
                                  this.onEventImprimirLetra(item.idPlazo)
                                }
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td className="small">
                                  {cobro.nombre}
                                  {<br />}
                                  {cobro.serie + '-' + cobro.numeracion}
                                </td>
                                <td className="small">{cobro.banco}</td>
                                <td className="small">
                                  {cobro.fecha}
                                  {<br />}
                                  {formatTime(cobro.hora)}
                                </td>
                                <td className="small">
                                  {numberFormat(cobro.precio, cobro.codiso)}
                                </td>
                                <td className="small">
                                  {numberFormat(montoActual, cobro.codiso)}
                                </td>
