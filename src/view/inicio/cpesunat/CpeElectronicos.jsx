...
import {
  ...
  sendNotaCredito,
  sendResumen,
  sendResumenNotaCredito,
} from '../../../network/rest/cpesunat.network';
import SuccessReponse from '../../../model/class/response';
import ErrorResponse from '../../../model/class/error-response';
import {
  listCpeSunat,
  sendEmailBoleta,
  sendEmailNotaCredito,
...
class CpeElectronicos extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      estados: [
        { id: '0', nombre: 'TODOS' },
        { id: '1', nombre: 'DECLARAR' },
        { id: '2', nombre: 'DAR DE BAJA' },
      ],
            ...
            if (response instanceof SuccessReponse) {
              ...
              if (object.state) {
                if (object.accept) {
                  alertSuccess(
                    'Facturación',
                    'Código ' + object.code + ' ' + object.description,
                    () => {
                      this.onEventPaginacion();
                    },
                  );
  ...
  onEventSendEmail(idCpeSunat, tipo) {
    if (tipo === 'f') {
      alertDialog(
        'Email',
        '¿Está seguro de envíar el email?',
        async (value) => {
          if (value) {
  ...
  onEventSendAnular = (idCpeSunat, tipo) => {
    if (tipo === 'f') {
      alertDialog(
        'Facturación',
        '¿Está seguro de anular el comprobante electrónico?',
        async (value) => {
          if (value) {
    ...
    return (
      <ContainerWrapper>
        ...
        <div
          ...
          id="modalExcel"
          tabIndex="-1"
          aria-labelledby="modalExcelLabel"
          aria-hidden={true}
        >
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="form-row">
                  <div className="form-group col-md-6">
                    <label htmlFor="categoria">
                      Fecha Inicio{' '}
                      <i className="fa fa-calendar text-danger small"></i>
                    </label>
                    <input
                      type="date"
                      ...
                      onChange={(event) =>
                        this.setState({ fechaInicioModal: event.target.value })
                      }
                    />
                  </div>
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        this.setState({ fechaFinalModal: event.target.value })
                      }
                    />
                  </div>
                </div>
                ...
                <div className="form-row">
                  <div className="form-group col-md-12">
                    <label htmlFor="categoria">
                      Fecha Inicio{' '}
                      <i className="fa fa-file-text text-danger small"></i>
                    </label>
                    <select
                      className="form-control"
                      ...
                      onChange={(event) =>
                        this.setState({
                          idComprobanteModal: event.target.value,
                        })
                      }
                    >
              ...
              <div className="modal-footer">
                <button
                  ...
                  onClick={() => this.onEventGenerarExcel()}
                >
                  Generar
                </button>
                <button
        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
            <div className="form-group">
              ...
              >
                <option value="any">Por sucursal</option>
                      ...
                      const estadoSunat =
                        item.estado === 0 ? (
                          <button
                            ...
                            onClick={() =>
                              this.onEventSendFactura(
                                item.idCpeSunat,
                                item.tipo,
                              )
                            }
                            disabled={!this.state.viewDeclarar}
                          >
                            <img src={images.error} alt="Error" width="22" />
                          </button>
                        ) : item.xmlSunat === '' ? (
                          <button
                            className="btn btn-light btn-sm"
                          ...
                          <button
                            ...
                            disabled={!this.state.viewDeclarar}
                          >
                            <img src={images.accept} alt="Aceptar" width="22" />
                          </button>
                        ) : (
                          <button
                            className="btn btn-light btn-sm"
                            ...
                            disabled={!this.state.viewDeclarar}
                          >
                            <img src={images.unable} alt="Incapaz" width="22" />
                          </button>
                        );
                              ...
                              >
                                <li>
                                  <button
                                    ...
                                    type="button"
                                    onClick={() =>
                                      this.onEventImprimir(
                                        item.idCpeSunat,
                                        item.tipo,
                                      )
                                    }
                                    disabled={!this.state.viewPdf}
                                  >
                                    <img
                                      src={images.pdf}
                                      width="22"
                                ...
                                <li>
                                  <button
                                    ...
                                    type="button"
                                    onClick={() =>
                                      this.onEventXmlSunat(
                                        item.idCpeSunat,
                                        item.tipo,
                                      )
                                    }
                                    disabled={!this.state.viewXml}
                                  >
                                    <img
                                      src={images.xml}
                                      width="22"
                                ...
                                <li>
                                  <button
                                    ...
                                    type="button"
                                    onClick={() =>
                                      this.onEventSendEmail(
                                        item.idCpeSunat,
                                        item.tipo,
                                      )
                                    }
                                    disabled={!this.state.viewEmail}
                                  >
                                    <img
                                      src={images.email}
                                      width="22"
                                ...
                                <li>
                                  <button
                                    ...
                                    type="button"
                                    onClick={() =>
                                      this.onEventSendAnular(
                                        item.idCpeSunat,
                                        item.tipo,
                                      )
                                    }
                                    disabled={!this.state.ViewResumenDiario}
                                  >
                                    <img
                                      src={images.error}
                                      width="22"
