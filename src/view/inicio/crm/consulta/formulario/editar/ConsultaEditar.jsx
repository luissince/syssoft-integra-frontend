...
class ConsultaEditar extends CustomComponent {
  constructor(props) {
    super(props);
    this.state = {
      idBanco: '',
...
const ConnectedConsultaEditar = connect(mapStateToProps, null)(ConsultaEditar);

export default ConnectedConsultaEditar;
