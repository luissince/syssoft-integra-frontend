...
import { alertDialog, alertInfo, alertSuccess, alertWarning, isEmpty, isText, spinnerLoading } from "../../../../helper/utils.helper";
import { updateBanco, getIdPerfil, updatePerfil } from "../../../../network/rest/principal.network";
...
class BancoEditar extends CustomComponent {
    ...
    async loadingData(id) {
        const [perfil] = await Promise.all([
            await this.fetchObtenerPerfil(id)
        ])
