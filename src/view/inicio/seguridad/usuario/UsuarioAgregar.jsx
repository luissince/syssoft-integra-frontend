...
import { addUsuario, comboPerfil } from '../../../../network/rest/principal.network';
...
class UsuarioAgregar extends CustomComponent {
    ...
    handleGuardar() {
        ...
        if (isEmpty(this.state.activeLogin && this.state.usuario)) {
            alertWarning("Usuario", "Ingrese su usuario para el inicio de sesión.", () => {
        ...
        if (isEmpty(this.state.activeLogin && this.state.clave)) {
            alertWarning("Usuario", "Ingrese su clave para el inicio de sesión.", () => {
                this.onFocusTab("login-tab", "login");
        ...
        if (this.state.activeLogin && isEmpty(this.state.configClave)) {
            alertWarning("Usuario", "Ingrese nuevamente su clave para el inicio de sesión.", () => {
                this.onFocusTab("login-tab", "login");
                ...
                <div className='row'>
                    <div className='col'>
                        <div className="form-group">
                            <h5>
                                <span role="button" onClick={() => this.props.history.goBack()}><i className="bi bi-arrow-left-short"></i>
                                </span> Registrar Usuario
                            </h5>
                        </div>
                    </div>
                </div>
