...
import { listUsuario, removeUsuario } from '../../../../network/rest/principal.network';
...
class Usuarios extends CustomComponent {
    ...
    fillTable = async (opcion, buscar) => {
        ...
        const response = await listUsuario(params, this.abortControllerTable.signal);
    ...
    handleBorrar(idUsuario) {
        alertDialog("Usuario", "¿Está seguro de que desea eliminar el usuario? Esta operación no se puede deshacer.", async (accept) => {
            if (accept) {
                const params = {
                    "idUsuario": idUsuario
                }
    ...
    generarBody() {
        ...
        return this.state.lista.map((item, index) => {
            ...
            const styleEstado = item.estado === 1 ? "badge badge-info" : "badge badge-danger";
