  ...
  loadingDataId = async (id) => {
    ...
    if (cliente.idTipoCliente === CLIENTE_NATURAL) {
      ...
      await this.setStateAsync({
        ...
        documentoPn: text(cliente.documento),
        informacionPn: text(cliente.informacion),
        clientePn: cliente.cliente,
        proveedorPn: cliente.proveedor,
        conductorPn: cliente.conductor,
        licenciaConductirPn: text(cliente.licenciaConducir),
        telefonoPn: text(cliente.telefono),
        celularPn: text(cliente.celular),
        fechaNacimiento: cliente.fechaNacimiento,
        emailPn: text(cliente.email),
        genero: text(cliente.genero),
        direccionPn: text(cliente.direccion),
      ...
      await this.setStateAsync({
        ...
        documentoPj: text(cliente.documento),
        informacionPj: text(cliente.informacion),
        clientePj: cliente.cliente,
        proveedorPj: cliente.proveedor,
        conductorPj: cliente.conductor,
        licenciaConductirPj: text(cliente.licenciaConducir),
        telefonoPj: text(cliente.telefono),
        celularPj: text(cliente.celular),
        emailPj: text(cliente.email),
        direccionPj: text(cliente.direccion),
    ...
    alertDialog('Persona', '¿Estás seguro de continuar?', async (accept) => {
      if (accept) {
        const data = {
          ...
          documento: this.state.documentoPj,
