...
import { getUbigeo, getIdSucursal, updateSucursal } from '../../../../network/rest/principal.network';
    ...
    render() {
        return (
            <ContainerWrapper>
                ...
                <div className='row'>
                    <div className='col'>
                        <div className="form-group">
                            <h5>
                                <span role="button" onClick={() => this.props.history.goBack()}><i className="bi bi-arrow-left-short"></i></span> Sucursal
                ...
                <div className='row'>
                    <div className='col'>
                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li className="nav-item" role="presentation">
                                <a className="nav-link" id="imagen-tab" data-bs-toggle="tab" href="#imagen" role="tab" aria-controls="imagen" aria-selected={false}>
                                ...
                                <div className="row">
                                    <div className="form-group col">
                                        ...
                                        <input
                                            ...
                                            onChange={(event) => this.setState({ direcion: event.target.value })}
                                ...
                                <div className="row">
                                    <div className="form-group col-md-6">
                                        ...
                                        <div className="custom-control custom-switch">
                                            ...
                                            <label className="custom-control-label" htmlFor="switch1">{this.state.estado ? "Habilitado" : "Inactivo"}</label>
                                        </div>
                                ...
                                <div className="row">
                                    <div className="col">
                                        <div className="form-group text-center">
                                            <input className='d-none' type="file" id="fileImage" accept="image/png, image/jpeg, image/gif, image/svg" ref={this.refFileImagen} />
                                            ...
                                            {" "}
                                            <button className="btn btn-outline-secondary" onClick={this.handleClearImage}>
                ...
                <div className='row'>
                    <div className="col">
                        <button type="button" className="btn btn-success" onClick={this.handleSave}><i className='fa fa-save'></i> Guardar</button>
                        <button type="button" className="btn btn-danger ml-2" onClick={() => this.props.history.goBack()}><i className='fa fa-close'></i> Cerrar</button>
                    </div>
                </div>
