...
import { listCargo, removeCargo } from '@/network/rest/api-client';
...
class Cargo extends CustomComponent<Props, State> {

  private abortControllerTable: AbortController;
  ...
  fillTable = async (opcion, buscar = '') => {
     ...
     * Peticion http
     */
    const response = await listCargo(
      params,
  ...
  handleEditar = (idCargo) => {
    this.props.history.push({
      pathname: `${this.props.location.pathname}/editar`,
      search: '?idCargo=' + idCargo,
    });
  };
  ...
  handleDelete = async (id) => {
    ...
    if (accept) {
      ...
      const response = await removeCargo(id);
        ...
        <TableRow key={index}>
          ...
          <TableCell className="text-center">
            <Button
              ...
              onClick={() => this.handleEditar(item.idCargo)}
            >
          ...
          <TableCell className="text-center">
            <Button
              ...
              onClick={() => this.handleDelete(item.idCargo)}
            >
...
const ConnectedCargo = connect(mapStateToProps, null)(Cargo);

export default ConnectedCargo;