...
import { createCargo } from '@/network/rest/api-client';
...
class CargosAgregar extends React.Component<Props, State> {
...
const ConnectedCargosAgregar = connect(
    mapStateToProps,
    null,
)(CargosAgregar);

export default ConnectedCargosAgregar;