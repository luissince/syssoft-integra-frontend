...
import { listUbicacion } from '@/network/rest/principal.network';
...
class Ubicaciones extends CustomComponent {
  constructor(props) {
    super(props);
  ...
  fillTable = async (opcion, buscar = "") => {
     ...
     * Peticion http
     */
    const response = await listUbicacion(
      params,
  ...
  handleEditar = (idUbicacion) => {
    this.props.history.push({
      pathname: `${this.props.location.pathname}/editar`,
      search: '?idUbicacion=' + idUbicacion,
    });
  };

  handleDelete = async (idUbicacion) => {
    const accept = await alertKit.question({
      title: "Ubicación",
      message: "¿Estás seguro de eliminar la Ubicación?",
      acceptButton: {
    ...
    if (accept) {
      ...
      const response = await removeAtributo(idUbicacion);
        ...
        <TableRow key={index}>
          ...
          <TableCell className="text-center">
            <Button
              ...
              onClick={() => this.handleEditar(item.idUbicacion)}
            >
          ...
          <TableCell className="text-center">
            <Button
              ...
              onClick={() => this.handleDelete(item.idUbicacion)}
            >
              ...
              <Table className={'table-bordered'}>
                <TableHeader className="thead-light">
                  <TableRow>
                    ...
                    <TableHead width="50%">Descripción</TableHead>
...
const ConnectedUbicaciones = connect(mapStateToProps, null)(Ubicaciones);

export default ConnectedUbicaciones;
