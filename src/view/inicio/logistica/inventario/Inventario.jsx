...
import { actualizarStockInventario, comboAlmacen, listInventario, obtenerStockInventario } from '../../../../network/rest/principal.network';
...
class Inventario extends CustomComponent {
    ...
    async fetchObtenerStockInvetario() {
        ...
        const response = await obtenerStockInventario(params, this.abortControllerTable.signal);
    ...
    generarBody() {
        ...
        return this.state.lista.map((item, index) => {
            const background = parseFloat(item.cantidad) <= 0 ? "bg-danger" : "bg-success";
