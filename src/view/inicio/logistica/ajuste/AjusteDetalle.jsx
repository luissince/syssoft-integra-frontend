...
class AjusteDetalle extends CustomComponent {
    ...
    async loadDataId(id) {
        const [ajuste] = await Promise.all([
            await this.fetchDetalleAjuste(id)
        ])
    ...
    async fetchDetalleAjuste(id) {
        ...
        const responde = await detailAjuste(params, this.abortControllerView.signal)
    ...
    render() {
        ...
        const { tipo, motivo, almacen, estado, fecha, hora, observacion } = this.state;
                                ...
                                <table width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{fecha} - {formatTime(hora)}</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Tipo de ajuste</th>
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{tipo}</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Motivo</th>
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{motivo}</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Almacen</th>
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{almacen}</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Observación</th>
                                            <th className="table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal">{observacion}</th>
                                        </tr>
                                        <tr>
                                            <th className="table-secondary w-25 p-1 font-weight-normal ">Estado</th>
                                            <th className={`table-light border-bottom w-75 pl-2 pr-2 pt-1 pb-1 font-weight-normal ${estado === 1 ? "text-success" : "text-danger"}`}>{estado === 1 ? "ACTIVO" : "ANULADO"}</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
