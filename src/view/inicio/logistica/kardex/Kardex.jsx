...
import { comboAlmacen, filtrarProducto, listKardex } from '../../../../network/rest/principal.network';
...
class Kardex extends CustomComponent {
    ...
    handleSelectAlmacen = (event) => {
        this.setState({
            ...
            nombreAlmacen: isEmpty(event.target.value) ? "TODOS LOS ALMACENES" : this.refIdAlmacen.current.options[this.refIdAlmacen.current.selectedIndex].innerText
        })
    }
            ...
            <ContainerWrapper>
                ...
                <div className="row mb-1">
                    <div className="col">
                        ...
                        <p><strong>Almacen:</strong> {this.state.nombreAlmacen}</p>
                        <p><strong>Cantidad Actual:</strong>  {cantidad} {producto && producto.medida}</p>
                        <p><strong>Valor del Producto:</strong> {numberFormat(costo, this.state.codISO)}</p>
                    </div>
                </div>
