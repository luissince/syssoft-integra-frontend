...
class ProductoDetalle extends CustomComponent {
  ...
  async loadDataId(id) {
    ...
    const response = await productoDetalle(
      data,
  ...
  async onEventGuardar() {
    ...
    alertDialog(
      'Producto',
      '¿Está seguro de registrar el asociado?. El producto va pasar a nombre del nuevo socio.',
      async (value) => {
        if (value) {
  ...
  async onEventLiberar() {
    alertDialog(
      'Producto',
      '¿Está seguro de liberar el producto?. Los cambios no son irreversibles.',
      async (value) => {
        if (value) {
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="form-group">
              ...
              <button
                type="button"
                className="btn btn-danger"
                onClick={() => this.onEventLiberar()}
              >
                <i className="fa fa-ban"></i> Liberar
              </button>
            </div>
          </div>
        </div>
              ...
              <table className="table table-borderless">
                <thead>
                  <tr>
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading && this.state.producto.categoria}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">Producto:</th>
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading && this.state.producto.producto}
                    </th>
                  </tr>
                  <tr>
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {' '}
                      {!this.state.loading && this.state.producto.productostado}
                    </th>
                  </tr>
                </thead>
              </table>
          ...
          <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            ...
            <div className="table-responsive">
              <table className="table table-borderless">
                <thead>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                      Medida Frontal (ML):
                    </th>
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading && this.state.producto.medidaFrontal}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading &&
                        this.state.producto.costadoDerecho}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                      Costado Izquierdo (ML):
                    </th>
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading &&
                        this.state.producto.costadoIzquierdo}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading && this.state.producto.medidaFondo}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {' '}
                      {!this.state.loading && this.state.producto.areaProducto}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {' '}
                      {!this.state.loading && this.state.producto.numeroPartida}
                    </th>
                  </tr>
                </thead>
              </table>
              ...
              <table className="table table-borderless">
                <thead>
                  <tr>
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading && this.state.producto.limiteFrontal}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading && this.state.producto.limiteDerecho}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading &&
                        this.state.producto.limiteIzquierdo}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {!this.state.loading &&
                        this.state.producto.limitePosterior}
                    </th>
                  </tr>
                  <tr>
                    <th className="w-35 font-weight-normal p-0">
                    ...
                    <th className="w-65 font-weight-bold p-0">
                      {' '}
                      {!this.state.loading &&
                        this.state.producto.ubicacionProducto}
                    </th>
                  </tr>
                </thead>
              </table>
