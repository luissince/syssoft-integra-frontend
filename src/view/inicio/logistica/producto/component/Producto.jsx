...
const Producto = (props) => {
    ...
    const { precios, refPrecios, handleInputNombrePrecios, handleInputPrecioPrecios, handleAddPrecio, handleRemovePrecio } = props;
        ...
        <div className="tab-pane fade show active" id="addproducto" role="tabpanel" aria-labelledby="addproducto-tab">
            ...
            <div className='row'>
                <div className="col">
                    <div className="form-group">
                        <label>
                            Indica si va ser tratado como unidades, valor monetario o granel(peso).
                        </label>
                    </div>
                </div>
            </div>
                    ...
                    <div className="form-group">
                        <div className="form-check form-check-inline">
                            <input
                                ...
                                type="radio"
                                name="tipoVenta" id="TV0001"
                                value="TV0001"
                                checked={idTipoVenta === 'TV0001'}
                                onChange={handleOptionTipoVenta} />
                            <label className="form-check-label" htmlFor="TV0001">Unidades</label>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="form-group">
                        <div className="form-check form-check-inline">
                            <input
                                className="form-check-input"
                                type="radio" name="tipoVenta"
                                id="TV0002"
                                value="TV0002"
                                checked={idTipoVenta === 'TV0002'}
                                onChange={handleOptionTipoVenta}
                            />
                            <label className="form-check-label" htmlFor="TV0002">Valor monetario</label>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="form-group">
                        <div className="form-check form-check-inline">
                            <input
                                ...
                                onChange={handleOptionTipoVenta} />
                            <label className="form-check-label" htmlFor="TV0003">A Granel</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='row'>
                <div className="col">
                    <div className="form-group">
                        <label>
                            Indica el valor de costo de compra de tu producto.
                        </label>
                    </div>
                </div>
            </div>
                    ...
                    <table ref={refPrecios} className="table table-borderless">
                        <thead>
                            <tr>
                                ...
                                <th className="text-center" scope="col">Quitar</th>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <input
                                                    ...
                                                    value={item.nombre}
                                                    onChange={(event) => handleInputNombrePrecios(event, item.id)}
                                                />
                                            </td>
                                            <td>
                                                <input
                                                    ...
                                                    placeholder="0.00"
                                                    value={item.precio}
                                                    onChange={(event) => handleInputPrecioPrecios(event, item.id)}
                                                    onKeyDown={keyNumberFloat}
                                                />
                                            </td>
                                            <td className="text-center">
                                                <button className="btn btn-danger" onClick={() => handleRemovePrecio(item.id)}>
