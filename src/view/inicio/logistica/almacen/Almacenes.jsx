...
class Almacenes extends CustomComponent {
    ...
    handleEliminar = (idAlmacen) => {
        alertDialog("Almacén", "¿Está seguro de que desea eliminar el almacen? Esta operación no se puede deshacer.", async (accept) => {
            if (accept) {
        ...
        return this.state.lista.map((item, index) => {
            return (
                <tr key={index}>
                    ...
                    <td>{item.departamento + "-" + item.provincia + "-" + item.distrito}</td>
