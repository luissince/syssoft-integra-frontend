class Tree {
    ...
    constructor(element) {
        ...
        const button = [].filter.call(three.querySelectorAll('li'), (elem) => elem.querySelector('i'));
        ...
        const li = [].filter.call(three.querySelectorAll('li'), (elem) => elem.querySelector('ul'));
        ...
        const input = [].filter.call(three.querySelectorAll('li'), (elem) => elem.querySelector('input'));
